...
<html lang="zh-CN">
    <head>
        ...
        <meta http-equiv="refresh" content="4; url = http://localhost/index.php/start/index" /><!-- 4秒钟后自动跳转到主界面  -->
        <title>密码修改成功</title>
    ...
    <body>
        ...
        <div class = "container">
            <div class="jumbotron" style="text-align: center; "> 
                ...
                <p style="font-size: 30px; color: red; text-align: center; margin-top: 30px; "> 您已经成功修改了密码</p>
                <p> <a class="btn btn-info btn-lg" href="http://localhost/index.php/start/index" role="button">将会在4秒后跳转</a></p>
            </div>
        </div>
