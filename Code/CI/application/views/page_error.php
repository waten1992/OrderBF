    ...
    <body>
        ...
        <div class = "container">
            <div class="jumbotron" style="text-align: center; "> 
                <h2>404 是什么鬼啊～</h2>
                <p style="font-size: 30px; color: red; text-align: center; margin-top: 30px; "> 你访问的页面不存在啦</p>
                <p> <a class="btn btn-info btn-lg" href="http://localhost/index.php/start/index" role="button">点击我来主页吧！</a></p>
            </div>
        </div>
