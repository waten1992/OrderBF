    ...
    <body>
                ...
                <div class = "container">
                    <div class = "navbar-header">
                        <a class = "navbar-brand" href = "/start">
                            <img src = "/images/logo.GIF" style = "width:75px">
                        </a>
                    </div>
                    <div class = "collapse navbar-collapse" >
                        <ul class = "nav navbar-nav"  >
                            <li class = "active"><a href ="/start" >首页</a> </li>                          
                            <li > <a href ="/start/register">注册</a> </li>
                            <li > <a href ="/start/about">关于orderbf</a> </li>
                            <li > <a href ="/start/contact">联系orderbf</a> </li>
                        </ul>
                        <div>
                            <a href="/start/login">
        ...
        <div class = "container">
            <div class="jumbotron" style="text-align: center; "> 
                ...
                <p> <a class="btn btn-info btn-lg" href="/start/about" role="button">详情</a></p>
            </div>
        </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/Soybean.png" alt="这个是豆浆" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br>
                        <p><a  href="/comments/index/<?php echo $soybean_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/bread01.jpg"  alt="这个是面包" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br/>
                        <p><a  href="/comments/index/<?php echo $bread_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/corn.GIF" alt="这个是玉米" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br/>
                        <p><a  href="/comments/index/<?php echo $corn_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/Tomato.GIF" alt="这个是番茄汁" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br/>
                        <p><a  href="/comments/index/<?php echo $tomato_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/carrot.GIF" alt="这个是胡萝卜" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br/>
                        <p><a  href="/comments/index/<?php echo $carrot_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/pd/mix_juice.GIF" alt="这个是混合果汁" style="width: 350px; height: 350px;">
                    <div class="caption">
                        ...
                        <br/>
                        <p><a  href="/comments/index/<?php echo $mix_juice_id; ?>" class="btn btn-info" role="button">看看评论吧～</a> </p>
                    </div>
                </div>
            </div>
