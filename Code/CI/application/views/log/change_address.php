    ...
    <body>
        ...
        <div class = "container">
            <div class="jumbotron" style="text-align: center; "> 
                ...
                <p style="font-size: 40px; color: red; text-align: center; margin-top: 30px; "> 请输入修改的地址</p>
                <div class="login-form" style="text-align: center; ">
                    <form name="input" action="http://localhost/index.php/start/handle_change_address" method="post">
                        <div class="control-group" >
                            <?php echo form_error('address'); ?> 
                             地址：<input type="text" name="address"  value="<?php echo set_value('address'); ?>" class="login-field"  placeholder="请输入地址" id="login-pass">
