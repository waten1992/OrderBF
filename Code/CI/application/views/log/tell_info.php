...
<html lang="zh-CN">
    <head>
        ...
        <meta http-equiv="refresh" content="4; url = http://localhost/index.php/start/login" /><!-- 4秒钟后自动跳转到登录界面  -->
        ...
        <div class = "container">
            <div class="jumbotron" style="text-align: center; "> 
                ...
                <p style="font-size: 30px; color: green; text-align: center; margin-top: 30px; "> Orderbf 专注为您设计早餐</p>
                 <p style="font-size: 25px; color: red; text-align: center; margin-top: 30px; "> 您还未登录</p>
                <p> <a class="btn btn-info btn-lg" href="http://localhost/index.php/start/login" role="button">请先登录</a></p>
            </div>
        </div>
